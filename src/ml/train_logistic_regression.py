#!/usr/bin/env python3
"""
Trains and saves the Logistic Regression baseline model.
"""
...
def train_logistic_regression(X_train, y_train, save_path: str) -> LogisticRegression:
    """
    Trains and saves a Logistic Regression classifier.
    """
    # Instantiate Logistic Regression with multinomial support
    ...
    with open(save_path, "wb") as f:
        pickle.dump(model, f)
    print(f"[+] Saved Logistic Regression model to {save_path}")
...
if __name__ == "__main__":
    ...
    model = train_logistic_regression(X_train_proc, y_train, save_path)
